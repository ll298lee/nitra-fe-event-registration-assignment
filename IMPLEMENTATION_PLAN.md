...
| #TBD                                                                              | `feat/step-3-order-summary` — pure `useOrderSummary` pricing engine: computed ticket/workshop/meal/merch lines, VIP workshop-only discount, subtotal/grand total + tests (D3, D11, D26; AC-P-\*, AC-4.2, AC-3.11) | _pending_ | **Open — awaiting human review** |
