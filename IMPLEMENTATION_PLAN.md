...
| #TBD                                                                              | `feat/step-3-merch-banner` — Step 3 UI part 2: `MerchCard` (size dropdown + qty stepper capped at `maxQuantity`, added state) + shipping banner (verbatim README copy) (D30, D16; AC-3.6/3.7/3.8/3.9/3.10)                                        | _pending_ | **Open — awaiting human review** |
