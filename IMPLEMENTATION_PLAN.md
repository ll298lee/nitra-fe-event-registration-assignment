...
- [x] `feat(validation)` step error indicators (red Review section cards + inline field/conflict
      markers, frame `1076:936`) + jump-to-step via the Edit links; Step 1 error from the Step 3
      merch condition (AC-4.5, AC-4.9, AC-1.6, D9, D36) — **PR 3**.
